...
class SinanewSpider(scrapy.Spider):
    ...
    def parse(self, response):
        url_list = []
        for i in range(15)[1:]:
            url = 'http://feed.mix.sina.com.cn/api/roll/get?pageid=153&lid=2509&k=&num=50&page={}&r=0.7356892603932603&callback=jQuery31109829711483500057_1525332319321&_=1525332319322'.format(
                i)
            url_list.append(url)
        for url in url_list:
