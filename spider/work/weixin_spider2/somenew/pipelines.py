        ...
        if (res2 is not True) and item['content']:
            ...
            try:
                ...
                if item['content']:
                    ...
                    if 'addr_county' in item.keys():
                        art.addr_county = item['addr_county']
                    if 'weixin_name' in item.keys():
                        art.weixin_name = item['weixin_name']
                    if 'weixin_hao' in item.keys():
                        art.weixin_hao = item['weixin_hao']
                    if 'weixin_renzheng' in item.keys():
                        art.weixin_renzheng = item['weixin_renzheng']
                    art.save()
