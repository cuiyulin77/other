...
class SinaLejuSpider(scrapy.Spider):
    ...
    for i in range(10)[1:]:
        ...
        url = 'http://info.leju.com/search/default/index?type=new_news&ver=2.0&appid=2017062081&count=1&field=title|tags|url|photo_manage|media|topcolumn|createtime|zhaiyao&pcount=10&page='+str(i)+'&order={createtime}desc&format=jsonp&filter3={id@neq}6459205775603842867|6459199924696563674|6459194891665980661|6459198230805920822|6459210809452313947|6459230774293216456&filter0={deleted@eq}0&filter1={city@eq}bj&filter2={topcolumn@eq}%E6%95%B0%E6%8D%AE|%E6%94%BF%E7%AD%96|%E5%9C%9F%E5%9C%B0|%E5%85%AC%E5%8F%B8|%E4%BA%BA%E7%89%A9|%E5%9C%B0%E4%BA%A7K%E7%BA%BF|%E5%9C%B0%E4%BA%A7%E6%9C%AD%E8%AE%B0|%E8%A7%81%E5%9C%B0&callback=jQuery1124022809688022592178_1540020561392'
        url_list.append(url)
    start_urls = url_list
    ...
    def parse(self, response):
        ...
        res = ret.replace('jQuery1124022809688022592178_1540020561392','').replace("(",'').replace(")",'')
    ...
    def parse_detail(self, response):
        ...
        item['come_from'] = response.xpath("//p[@class='origin']/span[2]//span/text()").extract_first()
        # 创建时间
